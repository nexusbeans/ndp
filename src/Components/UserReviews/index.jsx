                ...
                >
                        ...
                        <div className="item">
                            <div className="box">
                                <p className="reviewpara">
                                    <ReadMore text={"“I AM” has changed me for the better.  I am internally and externally at peace with myself.  I have happiness, joy, appreciation, and serenity.  Everyone should take time to this book; it will impact your self-preservation."} />
                                </p>
                    ...
                    <SwiperSlide>
                        <div className="item">
                            <div className="box">
                                <p className="reviewpara">
                                    <ReadMore text={'“A thought-provoking guide towards spirituality, happiness and still maintaining a normal life. The format is methodical, content well explained and grasping. For parents of young children, it’s like a textbook. Highly reaccommodated for people of all ages.'} />
                                </p>
                                <div className="user_review">
                    ...
                    <SwiperSlide>
                        ...
                        <div className="item">
                            <div className="box">
                                <p className="reviewpara">
                                    <ReadMore text={"When an individual faces drastic life changing experiences that place him in the only path to salvation and finds discovery of self, his world is unlocked with sudden enlightenment and spiritual blessings.  As Ashish's passion for his new life unravels and begins to unconditionally share his spiritual journey, Ashish crosses paths with Dr. Joshi, whom through their close friendship finds interest, enthusiasm and understanding to Ashish's spiritual journey.  Dr. Joshi has invested years in research, documenting and understanding Ashish's spiritual journey and has put together written literature based on facts and structure for the reader's understanding in capturing the true essence of Ashish's spiritual journey and studies that has brought him ultimate and unconditional happiness."} />
                                </p>
                                <div className="user_review">
