...
export default function AboutSet() {
  ...
  return (
    <>
      <Header />
      <main className="Contactup_main default_layout mb-0" id="Contactus_mainID">
          ...
          <Col>
            ...
            <div className="user_artical">
              ...
              <strong>Sri Ashish’s</strong> transformation began in December 2015 after he
                ...
                answer or direction. I sincerely need your help”. The next
                ...
                50 books on the subject including the Bhagavad Gita, the Bible,
                Ashtavakra Gita, Avadhuta Gita, Ribhu Gita, and Dhammapada –
                which awoke in him a realization that the only purpose of life
                is to know one’s true nature – this is called Realizing the Self
                or Self-Realization. Sri Ashish felt that he was still missing
                something in his quest to Realize the Truth, and this led to the
                most crucial turning point in Sri Ashish’s life - when he was
                ...
                Kriya Yoga (Dhyana Yoga). In 2021, he experienced shoonya
                (nothingness) – his original state of being, also known as
          ...
          <Container>
            <Col>
              ...
              <p>
                ...
                dreams. His life was like any other young man, filled with lots
                of fun and pleasure but mixed with an equal number of
                disappointments.
              </p>
              ...
              <p>
                ...
                we are seeking! Sri Ashish is your next-door neighbor with an
                uncanny ability to simplify the core spiritual message that is
                accessible by all.{" "}
              </p>
              </div>
            </Col>
