              ...
              <Row className="whtcontnt">
                <Col md={6}>
                  <p>
                    ...
                    forty-six, understood that this world is simply an illusion
                    as perceived through our senses and individuality. He wanted
                    to get more out of life and experience the Truth behind this
                  ...
                  <p>
                    ...
                    profound questions we often ask ourselves when sitting
                    alone, facing challenges, or striving for peace and
                    happiness: Who am I? Is there a God? Do prayers work? How is
                    spiritualism different than religion? What does it mean to
                    be enlightened? "I AM" will clarify your questions and
                    illuminate your path to enlightenment.
                  </p>
                </Col>
                <Col md={6}>
                  <p>
                    Written in a question-and-answer format and accessible to
                    all—young and experienced alike—this book distills the
                    essence of spiritualism as understood and experienced by an
                    ordinary human being amongst us. An ordinary human being
                    sharing his thoughts and experiences on spiritualism and
                  ...
                  <p>
                    ...
                    singular. God and I are one and the same in this Reality.
                    When our individuality or ego is dissolved, the appearance
                    of all perceived connections with this external and illusory
                    world dissolves. Thus, "Ashish" no longer exists, and a self
                    becomes the Self—a permanent and eternal state of
              ...
              <Row className="whyshouldcontnt">
                ...
                <Col md={6}>
                  ...
                  <p className="leftparagraph">
                    ...
                    root cause of all problems. The methods suggested are not
                    easy to implement, yet they are most effective in realizing
              ...
              <Row className=" whatsbook">
                ...
                <Col md={7} className=" leftpara">
                  ...
                  <p>
                    ...
                    Patanjali have guided his spiritual interests. Discovering
                    the ancient wisdom hidden in spiritual texts or in the minds
                    of yogis brings joy to his heart. Inspired by Ashish, this
                    book was written as an expression of that joy. Anil believes
